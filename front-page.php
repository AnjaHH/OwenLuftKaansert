<meta
  name="description"
  content="Forside for owen luft hjemmeside, viser video, samt rediregere til køb af billet. Coundown samt årets kunstnere er vist her. for neden ses tour de bar kort">
<?php
    ...
    <div class="box">
        ...
        <div class="hero-video">
            <?php
                ...
                if( $video ) {
                    echo '<video controls autoplay="autoplay" muted loop webkit-playsinline playsinline><source src="' 
        ...
        <div class="buy-ticket reveal">
            <a href="https://anjahein.dk/OwenLuftKaansert/billetsalg/" target="_blank" class="buy-hover"> <div class="buy-ticket-button">
            <h4>KØB BILLET </h4>
                </div></a> 
...
<?php the_content() ?>
  ...
  var artists = document.getElementsByClassName("artist");
            ...
            for (var i = 0; i < artists.length; i++) {
             ...
             document.getElementById("image-holder").style.backgroundImage = "url('" + artists[0].getAttribute("data-image-url") + "')";
